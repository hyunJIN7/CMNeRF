...
def process_stray_scanner(args, data, split='train'):
    ...
    """  
    conda activate StrayVisualizer-main    
    python data/process_strayscanner_data.py --depth_bound2=0.2 --depth_bound1=0.7 --basedir ./data/strayscanner/ds_a_5    

    """
    train_index = np.array([0, 184, 350, 1325, 1426])
    val_index = np.array([590, 1345, 1378, 1514])

    test_index = np.array([ 1400,1500])
    # all_index = np.arange(n)
