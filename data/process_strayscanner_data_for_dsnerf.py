...
def process_stray_scanner(args, data, split='train'):
    ...
    """
        ...
        python data/process_strayscanner_data_for_dsnerf.py --depth_bound2=0.2 --depth_bound1=0.7 --basedir ./data/strayscanner/h_5
    """
    train_index = np.array([0,152,339,420,579])
    val_index = np.array([397,595,885,1056])
